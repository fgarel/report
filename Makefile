...
qthelp:
	...
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/report.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/report"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/report"
	@echo "# devhelp"
